    ...
    return (
        <div className="flex items-center justify-center" ref={menuRef}>
            <motion.div animate={open ? "open" : "closed"} className="relative">
                ...
                >
                    <Option setOpen={setOpen} text="Github" Icon={FiGithub} link="https://github.com/yhanyi" />
                    <Option setOpen={setOpen} text="LinkedIn" Icon={FiLinkedin} link="https://www.linkedin.com/in/yeoh-han-yi/" />
                    <Downloadable setOpen={setOpen} text="Resume" Icon={FiDownload} link="/resume.pdf" />
                </motion.ul>
