...
import LinksBar from "@/components/links-dropdown";
...
export default function Home() {
    ...
    return (
        <main>
            <ThreeGradient />
            <div className="flex flex-col items-center justify-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 gap-5">
